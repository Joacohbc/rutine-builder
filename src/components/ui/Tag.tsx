...
export function Tag({ label, icon, variant = 'default', className, onClick }: TagProps) {
  const variants = {
    default: 'bg-surface border border-border text-text-muted hover:border-primary hover:text-primary',
    primary: 'bg-primary/10 text-primary border border-primary',
    outline: 'border border-border text-text-muted bg-surface-highlight',
  };
